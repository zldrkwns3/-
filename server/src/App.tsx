...
export default function App() {
  ...
  const [marketIndex, setMarketIndex] = useState<{ kospi: any | null; kosdaq: any | null } | null>(null);
  ...
  useEffect(() => {
    const fetchIndex = async () => {
      try {
        ...
        if (!data.error) setMarketIndex(data);
      } catch {}
    };
    fetchIndex();
  ...
  return (
    <DashboardLayout
      ...
      kospi={marketIndex?.kospi}
      kosdaq={marketIndex?.kosdaq}
    >
      {(() => {
